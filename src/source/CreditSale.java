 ...
 * @author adnan
 */
public class CreditSale extends javax.swing.JInternalFrame {
     ...
     */
    public CreditSale() throws IOException, FileNotFoundException, SQLException {
        initComponents();
    ...
    private void dataTableInvoiceNo() {
        ...
        try {
            String sql = "Select invoiceNo,"
                    ...
                    + "(select customername from customerinfo cin where cin.customerid=it.customerid) as 'customername'	,"
                    + "TotalAmount,netdiscount,"
                    + "TotalVat,"
                    + "Totalinvoice,"
                    + "paymentCurency,"
                    + "recieved,"
                    + "due,"
                    + "(select ad.name from admin ad where ad.id=it.inputuserid) as 'InputUser'"
                    + " from sale it where it.invoiceNo='" + invoicetext.getText() + "' ORDER BY invoiceNo DESC";
            ...
            if (rs.next()) {
                ...
                tree++;
                model2.addRow(new Object[]{tree, invoiceno, invoicedate, customername, totalrate, netdiscount, TotalVat, Totalinvoice, recieved, due, inputuser});
        ...
        try {
            String sql = "Select "
                    + "sum(TotalVat) as 'Total',"
                    + " sum(TotalAmount) as 'totalamt',"
                    + " sum(Totalinvoice) as 'nettotal',"
                    + " sum(recieved) as 'recieved', "
                    + " sum(due) as 'due' "
                    + " from sale where it it.invoiceNo='" + invoicetext.getText() + "'";
            pst = conn.prepareStatement(sql);
    ...
    private void dataTable_today() {
        ...
        try {
            String sql = "Select invoiceNo,"
                    ...
                    + "due,"
                    + "(select ad.name from admin ad where ad.id=it.inputuserid) as 'InputUser'"
                    + " from sale it where it.invoicedate='" + date + "' ORDER BY invoiceNo DESC";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
        ...
        try {
            String sql = "Select sum(TotalVat) as 'Total',"
                    + " sum(TotalAmount) as 'totalamt', "
                    + "sum(Totalinvoice) as 'nettotal',"
                    + " sum(recieved) as 'recieved', "
                    + " sum(due) as 'due' "
                    + "  from sale where invoicedate='" + date + "'";
            pst = conn.prepareStatement(sql);
    ...
    private void dataTable() {
        ...
        try {
            String sql = "Select invoiceNo,"
                    ...
                    + "due,"
                    + "(select ad.name from admin ad where ad.id=it.inputuserid) as 'InputUser'"
                    + " from sale it ORDER BY invoiceNo DESC";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
    ...
    private void cashsaleDetailsDate() {
        ...
        try {
            String sql = "Select invoiceNo,"
                    ...
                    + "due,"
                    + "(select ad.name from admin ad where ad.id=it.inputuserid) as 'InputUser'"
                    + " from sale it where it.invoicedate BETWEEN ? AND ? OR year(it.invoicedate)='" + yeartext.getText() + "' ORDER BY invoiceNo DESC";
            pst = conn.prepareStatement(sql);
        ...
        try {
            String sql = "Select sum(TotalVat) as 'Total',"
                    ...
                    + " sum(recieved) as 'recieved', "
                    + " sum(due) as 'due' "
                    + "  from sale  where invoicedate BETWEEN ? AND ? OR year(invoicedate)='" + yeartext.getText() + "'";
            pst = conn.prepareStatement(sql);
            pst.setString(1, ((JTextField) fromdatepayment.getDateEditor().getUiComponent()).getText());
            pst.setString(2, ((JTextField) todatepayment.getDateEditor().getUiComponent()).getText());
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        recievedtext = new javax.swing.JLabel();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(descriptiontext, javax.swing.GroupLayout.PREFERRED_SIZE, 699, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, 0)
        ...
        recievedtext.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        recievedtext.setForeground(new java.awt.Color(255, 255, 255));
        recievedtext.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));

        duetext.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        duetext.setForeground(new java.awt.Color(255, 255, 255));
        duetext.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(recievedtext, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel8)
                    .addComponent(duetext, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(2, 2, 2)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(recievedtext, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel8, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(duetext, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(3, 3, 3))
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        datatbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SI No", "Invoice No", "Invoice Date", "Customer ", "Amount", "Discount", "Vat", "Net Total", "Recieved", "Due", "Input User"
            }
        ) {
    ...
    private void datatblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_datatblMouseClicked
        ...
        try {
            String sql = "Select paymentCurency,customerid,Totalinvoice from sale sl  where sl.invoiceNo='" + invoiceNo + "'";
            pst = conn.prepareStatement(sql);
            ...
            if (rs.next()) {
                ...
                //totalinvoice=rs.getString("Totalinvoice");
    ...
    private void viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewActionPerformed
        ...
        String paymenttype = "Credit Invoice";
        ...
        try {
            ...
            Logger.getLogger(CreditSale.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        ...
        try {
            String inwords = convertToIndianCurrency(totalinvoice);
            //  String arebic = convertNumberToArabicWords(nettoal);
            // String inwords = convertToIndianCurrency(nettoal);
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        if (model2.getRowCount() == 0) {
            ...
            try {
                ...
                String totalrecieved = recievedtext.getText();
                String totaldue = duetext.getText();

                String titlehere = "Invoice Details";
                JRTableModelDataSource ItemJRBean = new JRTableModelDataSource(model2);
                JasperDesign jd = JRXmlLoader.load(new File("")
                        .getAbsolutePath()
                        + "/src/Report/CreditsaleDetails.jrxml");
                ...
                para.put("totalrecieved", totalrecieved);
    ...
    private javax.swing.JLabel recievedtext;
