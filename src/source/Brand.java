...
public class Brand extends javax.swing.JInternalFrame {
     ...
     */
    public Brand() throws IOException, SQLException {
        initComponents();
    ...
    private void table_update() throws SQLException {
        ...
        try {
            String sql = "Select id as 'Code',name as 'Name',remark ,status as 'Status' from brand ";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
    ...
    private void stockUpdate() {
        try {
            ...
            String sql = "Update brand set name='" + name.getText() + "',remark='" + remarktext.getText() + "',status='" + statusbox.getSelectedItem() + "' where id='" + id + "'";
            pst = conn.prepareStatement(sql);
            pst.execute();
    ...
    private void search() {
        ...
        try {
            ...
            String sql = "Select id as 'Code',name as 'Unit Name',remark ,status as 'Status' from unit where name LIKE CONCAT('%', ? ,'%')";
            pst = conn.prepareStatement(sql);
    ...
    private void datatblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_datatblMouseClicked
        try {
            ...
            String sql = "Select * from brand where id='" + table_click + "'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
