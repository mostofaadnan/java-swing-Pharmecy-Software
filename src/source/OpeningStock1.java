 ...
 * @author FAHIM
 */
public class OpeningStock1 extends javax.swing.JInternalFrame {
     ...
     */
    public OpeningStock1() throws IOException, SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        presentqty.setHorizontalAlignment(javax.swing.JTextField.CENTER);
    ...
    private void dataTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dataTableMouseClicked
        ...
        qtytext.setText(model.getValueAt(selectedRowIndex, 5).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            for (int row = 0; row < rows; row++) {
                String itemcode = (String) dataTable.getValueAt(row, 1);
                float qty = (Float) dataTable.getValueAt(row, 5);
                try {
                    String sql = "Update stockdetails set Qty='" + qty + "' where itemcode ='" + itemcode + "'";
                    pst = conn.prepareStatement(sql);
                    pst.execute();
                } catch (SQLException | HeadlessException e) {
                    JOptionPane.showMessageDialog(null, e);
