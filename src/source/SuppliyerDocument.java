 ...
 * @author adnan
 */
public class SuppliyerDocument extends javax.swing.JInternalFrame {
    ...
    int suppliyerid;
    /**
     * Creates new form SuppliyerDocument
     * @throws java.sql.SQLException
     * @throws java.io.IOException
     */
    public SuppliyerDocument() throws SQLException, IOException {
        initComponents();
...
private void suppliyercheck() throws SQLException {

        try {
            String sql = "Select * from suplyierInfo where id='"+suppliyerid+"' ";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            //tbl_employeeinfo.setModel(DbUtils.resultSetToTableModel(rs));
            while (rs.next()) {
                ...
                supliyerbox.setSelectedItem(name);
                //  supliyerbox.setSelectedIndex(id);
    ...
    private void table_update() throws SQLException {
        ...
        try {
            String sql = "Select id as 'Code', doctitle,(select si.supliyername from suplyierinfo si where si.id=sd.suppliyerid) as 'Suppliyer Name',docpath as 'Document Path' ,doctype as 'Document Type' from supplyerdocument sd ";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
      ...
      private void checkbysupplyier() throws SQLException {

        try {
            String sql = "Select id as 'Code', doctitle,(select si.supliyername from suplyierinfo si where si.id=sd.suppliyerid) as 'Suppliyer Name',docpath as 'Document Path' ,doctype as 'Document Type' from supplyerdocument sd where sd.suppliyerid='"+suppliyerid+"' ";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            datatbl.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (Exception e) {
        ...
        if (doctypebox.getSelectedIndex() > 0) {
            if (doctitle.getText().isEmpty() || file_path.getText().isEmpty()) {
                ...
                try {
                    ...
                    String sql = "Insert into supplyerdocument(doctitle,suppliyerid,doctype,docpath,picture) values(?,?,?,?,?)";
                    pst = conn.prepareStatement(sql);
    ...
    private void updateDocument() {
        ...
        try {
            ...
            String sql = "Update supplyerdocument set doctitle='" + doctitle.getText() + "',doctype='" + doctypebox.getSelectedItem() + "',docpath='" + file_path.getText() + "',picture=? where id='" + id + "'";
            pst = conn.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        seearchtext = new javax.swing.JTextField();
        ...
        jPanel1.add(pics_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(548, 36, 750, 484));

        jLabel6.setText("Preview");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(536, 11, -1, -1));
        ...
        jPanel3.add(docidtext, new org.netbeans.lib.awtextra.AbsoluteConstraints(107, 11, 142, 30));
        ...
        jLabel5.setText("Suppliyer");
        jPanel3.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(253, 11, 55, 30));
        ...
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, 29));

        seearchtext.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                seearchtextKeyReleased(evt);
            }
        });
        jPanel2.add(seearchtext, new org.netbeans.lib.awtextra.AbsoluteConstraints(55, 12, 200, 28));

        jLabel8.setText("Suppliyer");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(259, 12, 55, 28));
        ...
        jPanel2.add(supliyerbox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(318, 12, 200, 28));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 254, 520, 50));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 311, 522, 225));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (docidtext.getText().isEmpty()) {
            ...
            if (p == 0) {
                try {
                    String sql = "Delete from supplyerdocument where id=?";
                    pst = conn.prepareStatement(sql);
    ...
    private void datatblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_datatblMouseClicked
        ...
        try {
            ...
            String sql = "Select * from supplyerdocument where id='" + table_click + "'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            //tbl_employeeinfo.setModel(DbUtils.resultSetToTableModel(rs));
            while (rs.next()) {
    ...
    private void supliyerboxPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_supliyerboxPopupMenuWillBecomeInvisible
        ...
        try {
            String sql = "Select * from suplyierInfo where  supliyername='"+suplliyer+"'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            //tbl_employeeinfo.setModel(DbUtils.resultSetToTableModel(rs));
            while (rs.next()) {
    ...
    private void seearchtextKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_seearchtextKeyReleased
    String SearchText=seearchtext.getText();
        try {
            String sql = "Select id as 'Code', doctitle,(select si.supliyername from suplyierinfo si where si.id=sd.suppliyerid) as 'Suppliyer Name',docpath as 'Document Path' ,doctype as 'Document Type' from supplyerdocument sd where  doctitle LIKE CONCAT('%', ? ,'%')";
            pst = conn.prepareStatement(sql);
    ...
    }//GEN-LAST:event_seearchtextKeyReleased
    ...
    private javax.swing.JTextField seearchtext;
