 ...
 * @author adnan
 */
public class ColorManagement extends javax.swing.JInternalFrame {
Connection conn = null;
    ResultSet rs = null;
    PreparedStatement pst = null;
    /**
     * Creates new form ColorManagement
     * @throws java.io.IOException
     * @throws java.sql.SQLException
     */
    public ColorManagement() throws IOException, SQLException {
        initComponents();
...
private void addStock() throws SQLException {
        ...
        try {
            ...
            String sql = "Insert into color(name,remark,status) values(?,?,?)";
    ...
    private void table_update() throws SQLException {
        ...
        try {
            String sql = "Select id as 'Code',name as 'Counry Name',status as 'Status' from color ";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
    ...
    private void stockUpdate() {
        try {
            ...
            String sql = "Update color set name='" + banknametext.getText() + "',remark='" + remarktext.getText() + "',status='" + statusbox.getSelectedItem() + "' where id='" + id + "'";
            pst = conn.prepareStatement(sql);
    ...
    private void search() {
        ...
        try {
            ...
            String sql = "Select id as 'Code',name as 'Bank Name',status as 'Status' from color where name LIKE CONCAT('%', ? ,'%')";
            pst = conn.prepareStatement(sql);
    ...
    private void datatblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_datatblMouseClicked
        ...
        try {
            ...
            String sql = "Select * from color where id='" + table_click + "'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
