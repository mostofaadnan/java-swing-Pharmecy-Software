...
public class ImportView extends javax.swing.JInternalFrame {
   ...
   // Dashboard dashboard = new Dashboard();
     ...
     */
    public ImportView(String table_click, int importM) throws SQLException, IOException {
        initComponents();
 ...
 private void userkey() throws  IOException, SQLException {
    ...
    private void PurchaseDetailsPR(String table_click) throws SQLException {
        ...
        try {
            ...
            String sql = "Select pr.prcode as 'id',(select ita.itemName from item ita where ita.Itemcode=pr.prcode) as 'Itemname',unitrate, qty,unit,total,discount,comisionInpersantage,comissionperitem,totalcommision from importdetails pr  where pr.importCode='" + table_click + "'";
            pst = conn.prepareStatement(sql);
        ...
        try {
            ...
            String sql = "Select Totalrate,importCode,supliyer,countryid,pdate,(select sp.supliyername from suplyierinfo sp where sp.id=im.supliyer) as 'supliyername',(select cy.name from country cy where cy.id=im.countryid) as 'countryname',netcommision  from import im where im.importCode='" + table_click + "'";
            pst = conn.prepareStatement(sql);
            ...
            if (rs.next()) {
                ...
                String ParchseNo = rs.getString("importCode");
    ...
    private void importupdate() {
        try {
            ...
            String sql = "Update import set pdate='" + date + "',supliyer='" + supid + "',Totalrate='" + totalrate.getText() + "',countryid='" + countryid + "',netcommision='"+nettotalcommitiontext.getText()+"' where importCode='" + parchaseText.getText() + "'";
            pst = conn.prepareStatement(sql);
 ...
 private static final DecimalFormat df2 = new DecimalFormat("#.00");
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addComponent(countrybox, javax.swing.GroupLayout.PREFERRED_SIZE, 269, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(1, 1, 1)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lottext, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(totalrate, javax.swing.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)
        ...
        svbtn.setBackground(new java.awt.Color(0, 153, 51));
        ...
        hereLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, hereLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(svbtn, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
        ...
        hereLayout.setVerticalGroup(
            ...
            .addGroup(hereLayout.createSequentialGroup()
                ...
                .addGroup(hereLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(svbtn, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void StockloadMinus() {
        ...
        try {
            String sql1 = "Select st.Qty as 'stockqty' from stock st where st.procode=(Select pc.prcode from importdetails pc where pc.prcode=st.procode AND pc.importCode='" + parchaseText.getText() + "' )";
            ...
            while (rs.next()) {
                ...
                String sql = "Update stock sta set sta.Qty=(Select pc.qty-'" + updateqty + "'  from importdetails pc where pc.prcode=sta.procode AND pc.importCode='" + parchaseText.getText() + "') where (select pc.prcode from importdetails pc where pc.prcode=sta.procode AND pc.importCode='" + parchaseText.getText() + "')=sta.procode";
    ...
    private void SuppliyerUpdate() {
        try {
            ...
            String sql = "Update suppliyer_import_export_balance set supid ='" + supid + "',countryid='" + countryid + "',importAmount='" + totalrate.getText() + "' where exportimportcode='" + parchaseText.getText() + "'";
            pst = conn.prepareStatement(sql);
    ...
    private void deletebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebtnActionPerformed
        if (importmodification == 0) {
            ...
            int p = JOptionPane.showConfirmDialog(null, "Do you really want to delete This Execute Import Data", "Delete", JOptionPane.YES_NO_OPTION);
            if (p == 0) {
