 ...
 * @author adnan
 */
public class Size extends javax.swing.JInternalFrame {
Connection conn = null;
     ...
     */
    public Size() throws SQLException, IOException {
        initComponents();
    ...
    private void addStock() throws SQLException {
        ...
        try {
            ...
            String sql = "Insert into itemsize(size) values(?)";
    ...
    private void table_update() throws SQLException {
        ...
        try {
            String sql = "Select id as 'Code',size as 'Size' from itemsize ";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
    ...
    private void stockUpdate() {
        try {
            ...
            String sql = "Update itemsize set size='" + banknametext.getText() + "' where id='" + id + "'";
            pst = conn.prepareStatement(sql);
    ...
    private void search() {
        ...
        try {
            ...
            String sql = "Select id as 'Code',size as 'Size' from itemsize where size LIKE CONCAT('%', ? ,'%')";
            pst = conn.prepareStatement(sql);
    ...
    private void datatblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_datatblMouseClicked
        ...
        try {
            ...
            String sql = "Select * from itemsize where id='" + table_click + "'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                ...
                String sname = rs.getString("size");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int p = JOptionPane.showConfirmDialog(null, "Do you really want to delete Data", "Delete", JOptionPane.YES_NO_OPTION);      try {
                String sql = "Delete from itemsize where id=?";
                pst = conn.prepareStatement(sql);
