 ...
 * @author adnan
 */
public class MobileBanktype extends javax.swing.JInternalFrame {
Connection conn = null;
    ResultSet rs = null;
    PreparedStatement pst = null;
    /**
     * Creates new form MobileBanktype
     * @throws java.io.IOException
     * @throws java.sql.SQLException
     */
    public MobileBanktype() throws IOException, SQLException {
        initComponents();
...
private void addStock() throws SQLException {
        ...
        try {
            ...
            String sql = "Insert into mobilebank(name,remark,status) values(?,?,?)";
    ...
    private void table_update() throws SQLException {
        ...
        try {
            String sql = "Select id as 'Code',name as 'Counry Name',status as 'Status' from mobilebank ";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
    ...
    private void stockUpdate() {
        try {
            ...
            String sql = "Update mobilebank set name='" + banknametext.getText() + "',remark='" + remarktext.getText() + "',status='" + statusbox.getSelectedItem() + "' where id='" + id + "'";
            pst = conn.prepareStatement(sql);
    ...
    private void search() {
        ...
        try {
            ...
            String sql = "Select id as 'Code',name as 'Bank Name',status as 'Status' from mobilebank where name LIKE CONCAT('%', ? ,'%')";
            pst = conn.prepareStatement(sql);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (p == 0) {
            try {
                String sql = "Delete from mobilebank where id=?";
                pst = conn.prepareStatement(sql);
    ...
    private void datatblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_datatblMouseClicked
        ...
        try {
            ...
            String sql = "Select * from mobilebank where id='" + table_click + "'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
